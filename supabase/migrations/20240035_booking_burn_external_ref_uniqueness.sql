-- =============================================================================
-- Booking burn split rows: make external_ref unique per allocation row
-- - Prevents duplicate-key collisions when one booking burn is split across lots
-- - Keeps canonical booking id in metadata for downstream lookups
-- =============================================================================
