-- =============================================================================
-- Fix booking RPC for generated/default range columns
-- - Some environments define bookings.time_range and booking_holds.hold_range
--   as generated or otherwise non-writable columns.
-- - Avoid explicit writes and let DB defaults/triggers/generated expressions handle them.
-- =============================================================================
...
BEGIN
  ...
  -- Do not write generated/default range columns directly.
