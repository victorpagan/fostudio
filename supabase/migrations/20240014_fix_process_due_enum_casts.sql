-- =============================================================================
-- Fix enum/text handling in process_due_membership_credit_grants
-- - Some environments use enum membership_status / membership_tier.
-- - Avoid COALESCE(enum, '') and text=enum comparisons.
-- =============================================================================
